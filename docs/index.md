...
-   [What's New for SAP Business Application Studio](what-s-new-for-sap-business-application-studio-ed631d4.md)
    -   [2024 What's New for SAP Business Application Studio](2024-what-s-new-for-sap-business-application-studio-699362d.md)
    -   [2023 What's New for SAP Business Application Studio](2023-what-s-new-for-sap-business-application-studio-29922e0.md)
    ...
    -   [Working in SAP Business Application Studio](working-in-sap-business-application-studio-bfc5178.md)
        ...
        -   [Develop](develop-5126b9b.md)
            ...
            -   [Git Source Control](git-source-control-9689c07.md)
                ...
                -   [Providing Authentication to Git](providing-authentication-to-git-8b1d618.md)
            ...
            -   [Runtime Version Management](runtime-version-management-8270e77.md)
            -   [Runtime Capabilities Editor](runtime-capabilities-editor-35e89d8.md)
        ...
        -   [Test and Run](test-and-run-9a16a55.md)
            ...
            -   [Stopping a Process](stopping-a-process-c4476db.md)
...
-   [Administrator Guide](administrator-guide-545ba7d.md)
    -   [Set Up SAP Business Application Studio](set-up-sap-business-application-studio-19611dd.md)
    ...
    -   [Application Plans](application-plans-2c72917.md)
        -   [Changing Plans](changing-plans-4cf7c69.md)
...
-   [Security Guide](security-guide-7b2bdd5.md)
    ...
    -   [Encryption with a Customer-Managed Key](encryption-with-a-customer-managed-key-68e6d6f.md)
    -   [Data Protection and Privacy](data-protection-and-privacy-3ad7520.md)
    -   [Malware Scan in Dev Spaces](malware-scan-in-dev-spaces-d259b7a.md)
    -   [Security Recommendations and Considerations](security-recommendations-and-considerations-5648ce0.md)
